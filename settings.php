...
// Added section and
	add_settings_section( 'atss_section_on', 'Текст перед ссылкой Privacy Policy', '', $atss_page );
...
// Create a text box of the first section
	...
	add_settings_field( 'atsy_text_tex_field', 'Текст перед ссылкой на страницу правил<br />конфиденциальности сайта', 'atss_option_display_settings_texs', $atss_page, 'atss_section_on', $atss_field_params );
}
...
// Added section and
	add_settings_section( 'atss_section_on', 'Текст перед ссылкой на Privacy Policy:', '', $atss_page );
...
// Create a text box of the first section
	...
	add_settings_field( 'atsy_text_links_field', 'Можно указать текст ссылки<br />Privacy Policy', 'atss_option_display_settings_texs_links', $atss_page, 'atss_section_on', $atss_field_params );
}
// link text
...
// Create a text box of the first section
	...
	add_settings_field( 'atsy_text_field', 'Ссылка на страницу<br />правил Privacy Policy', 'atss_option_display_settings', $atss_page, 'atss_section_on', $atss_field_params );
}
